...
import '../country_picker/country-picker-utils.dart';
...
class _CupertinoCountryPickerState extends State<CountryPickerCupertino> {
  final List<Country> _allCountries = countriesList.map((item) => Country.fromMap(item)).toList();
  List<Country> _countries;

  @override
  void initState() {
    _allCountries.sort((a, b) => a.name.toLowerCase().compareTo(b.name.toLowerCase()));
