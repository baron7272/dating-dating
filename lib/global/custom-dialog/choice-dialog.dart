...
import 'my-alert-dialog.dart';

class ChoiceDialogs<T> extends StatefulWidget {
  ...
  @override
  _ChoiceDialogsState<T> createState() => _ChoiceDialogsState<T>();
}

class _ChoiceDialogsState<T> extends State<ChoiceDialogs<T>> {
  T _chosenItem;
